...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Parametres_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 132, 19)
    },
    "Parametres\0on_pushButton_clicked\0\0"
    "on_radioButton_clicked\0on_radioButton_2_clicked\0"
    "on_radioButton_4_clicked\0"
    "on_radioButton_3_clicked\0on_checkBox_clicked\0"
};
...
const QMetaObject Parametres::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Parametres.data,
      qt_meta_data_Parametres,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Parametres.stringdata))
