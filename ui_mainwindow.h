...
public:
    ...
    QAction *actionListe_des_points_de_vente;
    QAction *actionAutres_produits;
    QAction *actionSynchroniser_les_donn_es;
    QAction *actionSauvegarder_la_base_de_donn_es;
    QAction *actionRestaurer_la_base_de_donn_es;
    QAction *actionListe_des_utilisateurs;
    QAction *actionParam_tres;
    QAction *actionListe_des_clients;
    QAction *actionAjouter;
    QAction *actionCat_gories;
    QAction *actionClients_avec_impay_s;
    QAction *actionClients_avec_pr_payements;
    ...
    QGridLayout *grid_point_de_vente;
    ...
    QLabel *label_12;
    QComboBox *inventaire_format;
    QVBoxLayout *verticalLayout_6;
    QLabel *label;
    QComboBox *inventaire_type;
    QVBoxLayout *verticalLayout_7;
    QLabel *label_2;
    QComboBox *inventaire_point_vente;
    QVBoxLayout *slfjslfs;
    QLabel *label_3;
    QComboBox *inventaire_utilisateurs;
    QVBoxLayout *inventaire_du;
    QLabel *label_4;
    QDateEdit *inventaire_du_2;
    QVBoxLayout *verticalLayout_10;
    QLabel *label_5;
    QDateEdit *inventaire_au;
    QTableWidget *table_inventaire;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setStyleSheet(QLatin1String("QGroupBox:title{\n"
"	color: rgb(170, 0, 0);\n"
"	font-weight:bold;\n"
"}"));
        ...
        actionParametres->setEnabled(false);
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/img/images/Tftclean.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionParametres->setIcon(icon1);
        QFont font;
        font.setPointSize(16);
        actionParametres->setFont(font);
        actionParametres->setVisible(true);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/img/images/exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionFermer->setIcon(icon3);
        actionListe_des_points_de_vente = new QAction(MainWindow);
        actionListe_des_points_de_vente->setObjectName(QStringLiteral("actionListe_des_points_de_vente"));
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/img/images/storefront-outline.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionListe_des_points_de_vente->setIcon(icon4);
        actionAutres_produits = new QAction(MainWindow);
        actionAutres_produits->setObjectName(QStringLiteral("actionAutres_produits"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/img/images/ellipsis-horizontal-circle-outline.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionAutres_produits->setIcon(icon5);
        actionSynchroniser_les_donn_es = new QAction(MainWindow);
        actionSynchroniser_les_donn_es->setObjectName(QStringLiteral("actionSynchroniser_les_donn_es"));
        QIcon icon6;
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/img/images/patient.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionListe_des_utilisateurs->setIcon(icon9);
        actionParam_tres = new QAction(MainWindow);
        actionParam_tres->setObjectName(QStringLiteral("actionParam_tres"));
        QIcon icon10;
        icon10.addFile(QStringLiteral(":/img/images/hammer-outline.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionParam_tres->setIcon(icon10);
        actionListe_des_clients = new QAction(MainWindow);
        actionListe_des_clients->setObjectName(QStringLiteral("actionListe_des_clients"));
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/img/images/people-outline.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionListe_des_clients->setIcon(icon11);
        actionAjouter = new QAction(MainWindow);
        actionAjouter->setObjectName(QStringLiteral("actionAjouter"));
        QIcon icon12;
        icon12.addFile(QStringLiteral(":/img/images/grid-outline.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionAjouter->setIcon(icon12);
        actionCat_gories = new QAction(MainWindow);
        actionCat_gories->setObjectName(QStringLiteral("actionCat_gories"));
        QIcon icon13;
        icon13.addFile(QStringLiteral(":/img/images/print-outline.svg"), QSize(), QIcon::Normal, QIcon::Off);
        actionCat_gories->setIcon(icon13);
        actionClients_avec_impay_s = new QAction(MainWindow);
        actionClients_avec_impay_s->setObjectName(QStringLiteral("actionClients_avec_impay_s"));
        actionClients_avec_pr_payements = new QAction(MainWindow);
        actionClients_avec_pr_payements->setObjectName(QStringLiteral("actionClients_avec_pr_payements"));
        actionAlertes = new QAction(MainWindow);
        actionAlertes->setObjectName(QStringLiteral("actionAlertes"));
        QIcon icon14;
        icon14.addFile(QStringLiteral(":/img/images/alerte2.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAlertes->setIcon(icon14);
...
"font-size:16px;"));
        ...
        date_recette = new QDateEdit(block_points_vente);
        date_recette->setObjectName(QStringLiteral("date_recette"));
        date_recette->setCalendarPopup(true);

        horizontalLayout_14->addWidget(date_recette);

        utilisateur_recette = new QComboBox(block_points_vente);
        utilisateur_recette->setObjectName(QStringLiteral("utilisateur_recette"));
        utilisateur_recette->setEditable(true);

        horizontalLayout_14->addWidget(utilisateur_recette);


        verticalLayout_4->addLayout(horizontalLayout_14);

        table_recette = new QTableWidget(block_points_vente);
        if (table_recette->columnCount() < 2)
            table_recette->setColumnCount(2);
        QTableWidgetItem *__qtablewidgetitem = new QTableWidgetItem();
        table_recette->setHorizontalHeaderItem(0, __qtablewidgetitem);
        ...
        verticalLayout_4->addWidget(table_recette);
...
"padding:4px;"));
        ...
        scrollArea->setMaximumSize(QSize(16777215, 20));
        scrollArea->setAutoFillBackground(false);
        scrollArea->setStyleSheet(QLatin1String("padding:0;\n"
"margin:0;"));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 231, 56));
        ...
        grid_point_de_vente = new QGridLayout();
        grid_point_de_vente->setSpacing(6);
        grid_point_de_vente->setObjectName(QStringLiteral("grid_point_de_vente"));

        verticalLayout_3->addLayout(grid_point_de_vente);
        ...
        pushButton_9 = new QPushButton(block_points_vente);
        pushButton_9->setObjectName(QStringLiteral("pushButton_9"));
        pushButton_9->setStyleSheet(QLatin1String("background-color:white;\n"
"border:none;"));
        QIcon icon16;
        icon16.addFile(QStringLiteral(":/img/images/sync-outline.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_9->setIcon(icon16);
        ...
        verticalLayout->addWidget(block_points_vente);
        ...
        toolButton_12->setMinimumSize(QSize(100, 0));
        toolButton_12->setMaximumSize(QSize(100, 999999));
        toolButton_12->setStyleSheet(QLatin1String("background-color:white;\n"
"border:none;"));
        QIcon icon17;
        ...
        toolButton_13->setMinimumSize(QSize(100, 0));
        toolButton_13->setMaximumSize(QSize(100, 999999));
        toolButton_13->setStyleSheet(QLatin1String("background-color:white;\n"
"border:none;"));
        QIcon icon18;
        ...
        toolButton_10->setMinimumSize(QSize(100, 0));
        toolButton_10->setMaximumSize(QSize(9999999, 9999999));
        toolButton_10->setStyleSheet(QLatin1String("background-color:white;\n"
"border:none;"));
        QIcon icon19;
        ...
        toolButton_11->setMinimumSize(QSize(0, 0));
        toolButton_11->setMaximumSize(QSize(100, 999999));
        toolButton_11->setStyleSheet(QLatin1String("background-color:white;\n"
"border:none;"));
        QIcon icon20;
        ...
        label_12->setStyleSheet(QLatin1String("font-weight:bold;\n"
"font-size:8px;"));

        verticalLayout_17->addWidget(label_12);

        inventaire_format = new QComboBox(groupBox_3);
        inventaire_format->setObjectName(QStringLiteral("inventaire_format"));
        inventaire_format->setEditable(true);

        verticalLayout_17->addWidget(inventaire_format);
...
"font-size:8px;"));
        ...
        inventaire_type = new QComboBox(groupBox_3);
        inventaire_type->setObjectName(QStringLiteral("inventaire_type"));
        inventaire_type->setEditable(true);

        verticalLayout_6->addWidget(inventaire_type);
...
"font-size:8px;"));
        ...
        inventaire_point_vente = new QComboBox(groupBox_3);
        inventaire_point_vente->setObjectName(QStringLiteral("inventaire_point_vente"));
        inventaire_point_vente->setEditable(true);

        verticalLayout_7->addWidget(inventaire_point_vente);


        horizontalLayout_3->addLayout(verticalLayout_7);

        slfjslfs = new QVBoxLayout();
        slfjslfs->setSpacing(6);
        slfjslfs->setObjectName(QStringLiteral("slfjslfs"));
...
"font-size:8px;"));
        ...
        slfjslfs->addWidget(label_3);

        inventaire_utilisateurs = new QComboBox(groupBox_3);
        inventaire_utilisateurs->setObjectName(QStringLiteral("inventaire_utilisateurs"));
        inventaire_utilisateurs->setEditable(true);

        slfjslfs->addWidget(inventaire_utilisateurs);


        horizontalLayout_3->addLayout(slfjslfs);

        inventaire_du = new QVBoxLayout();
        inventaire_du->setSpacing(6);
        inventaire_du->setObjectName(QStringLiteral("inventaire_du"));
...
"font-size:8px;"));
        ...
        inventaire_du->addWidget(label_4);

        inventaire_du_2 = new QDateEdit(groupBox_3);
        inventaire_du_2->setObjectName(QStringLiteral("inventaire_du_2"));
        inventaire_du_2->setStyleSheet(QStringLiteral("height:18px"));
        inventaire_du_2->setCalendarPopup(true);

        inventaire_du->addWidget(inventaire_du_2);


        horizontalLayout_3->addLayout(inventaire_du);
...
"font-size:8px;"));
        ...
        inventaire_au = new QDateEdit(groupBox_3);
        inventaire_au->setObjectName(QStringLiteral("inventaire_au"));
        inventaire_au->setStyleSheet(QStringLiteral("height:18px"));
        inventaire_au->setCalendarPopup(true);

        verticalLayout_10->addWidget(inventaire_au);
        ...
        table_inventaire->setHorizontalHeaderItem(1, __qtablewidgetitem3);
        QTableWidgetItem *__qtablewidgetitem4 = new QTableWidgetItem();
        table_inventaire->setHorizontalHeaderItem(2, __qtablewidgetitem4);
        QTableWidgetItem *__qtablewidgetitem5 = new QTableWidgetItem();
        table_inventaire->setHorizontalHeaderItem(3, __qtablewidgetitem5);
        QTableWidgetItem *__qtablewidgetitem6 = new QTableWidgetItem();
        table_inventaire->setHorizontalHeaderItem(4, __qtablewidgetitem6);
        ...
        verticalLayout_11->addWidget(table_inventaire);
        ...
        label_6->setStyleSheet(QLatin1String("font-size:12px;\n"
"font-weight:bold;\n"
"color:rgb(170,0,0);"));
        ...
        pushButton_2->setStyleSheet(QLatin1String("padding:5px;\n"
...
""));
        ...
        label_7->setStyleSheet(QLatin1String("font-size:10px;\n"
"color:black;\n"
"font-weight:bold;"));

        verticalLayout_8->addWidget(label_7);

        produits = new QComboBox(groupBox_4);
        produits->setObjectName(QStringLiteral("produits"));
        produits->setEditable(true);

        verticalLayout_8->addWidget(produits);
        ...
        label_13->setStyleSheet(QStringLiteral("font-size:10px;"));
        label_13->setAlignment(Qt::AlignCenter);

        verticalLayout_14->addWidget(label_13);

        label_format = new QLabel(groupBox_4);
        label_format->setObjectName(QStringLiteral("label_format"));
        label_format->setStyleSheet(QStringLiteral("font-size:10px;"));
        label_format->setAlignment(Qt::AlignCenter);

        verticalLayout_14->addWidget(label_format);
        ...
        label_14->setStyleSheet(QStringLiteral("font-size:10px;"));
        label_14->setAlignment(Qt::AlignCenter);

        verticalLayout_16->addWidget(label_14);

        label_qte = new QLabel(groupBox_4);
        label_qte->setObjectName(QStringLiteral("label_qte"));
        label_qte->setStyleSheet(QStringLiteral("font-size:10px;"));
        label_qte->setAlignment(Qt::AlignCenter);

        verticalLayout_16->addWidget(label_qte);
        ...
        label_8->setStyleSheet(QLatin1String("font-size:10px;\n"
"color:black;\n"
"font-weight:bold;"));
        ...
        horizontalLayout_5->addWidget(qte);

        unite = new QComboBox(groupBox_4);
        unite->setObjectName(QStringLiteral("unite"));
        unite->setEditable(true);

        horizontalLayout_5->addWidget(unite);
        ...
        label_9->setStyleSheet(QLatin1String("font-size:10px;\n"
"color:black;\n"
"font-weight:bold;"));
        ...
        label_10->setStyleSheet(QLatin1String("font-size:10px;\n"
"color:black;\n"
"font-weight:bold;"));

        verticalLayout_13->addWidget(label_10);

        total = new QLineEdit(groupBox_4);
        total->setObjectName(QStringLiteral("total"));
        total->setEnabled(false);
        total->setReadOnly(true);

        verticalLayout_13->addWidget(total);
...
""));
        ...
        table_vente->setFrameShape(QFrame::NoFrame);
...
"background-color:white;"));
        ...
        total_facture = new QLabel(groupBox_4);
        total_facture->setObjectName(QStringLiteral("total_facture"));
        total_facture->setStyleSheet(QLatin1String("font-size:10px;\n"
"font-weight:bold;\n"
"color:black;\n"
""));
...
""));
        ...
        list_clients = new QComboBox(groupBox_4);
        list_clients->setObjectName(QStringLiteral("list_clients"));
        list_clients->setEditable(true);

        horizontalLayout_4->addWidget(list_clients);
...
"border:none;"));
        ...
        pushButton_11->setStyleSheet(QLatin1String("background-color:white;\n"
"border:none;\n"
"padding:5px;"));
        QIcon icon23;
        icon23.addFile(QStringLiteral(":/img/images/vente.png"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_11->setIcon(icon23);
...
"padding:5px;"));
        QIcon icon24;
        icon24.addFile(QStringLiteral(":/img/images/logo-bitcoin.svg"), QSize(), QIcon::Normal, QIcon::Off);
...
"padding:5px;"));
        QIcon icon25;
        icon25.addFile(QStringLiteral(":/img/images/bag-remove-outline.svg"), QSize(), QIcon::Normal, QIcon::Off);
        pushButton_8->setIcon(icon25);
...
"padding:5px;"));
        ...
        list_prepaye = new QGroupBox(centralWidget);
        list_prepaye->setObjectName(QStringLiteral("list_prepaye"));

        horizontalLayout_10->addWidget(list_prepaye);

        impayes = new QGroupBox(centralWidget);
        impayes->setObjectName(QStringLiteral("impayes"));

        horizontalLayout_10->addWidget(impayes);
...
"color:white;"));
        ...
        menuPoints_de_vente = new QMenu(menuBar);
        ...
        menuUtilisateurs->setObjectName(QStringLiteral("menuUtilisateurs"));
        ...
        menuBar->addAction(menuPoints_de_vente->menuAction());
        menuBar->addAction(menuStock->menuAction());
        menuBar->addAction(menuSynchronisation->menuAction());
        menuBar->addAction(menuUtilisateurs->menuAction());
        menuBar->addAction(menuClients->menuAction());
        menuFichier->addAction(actionParam_tres);
        ...
        menuUtilisateurs->addAction(actionListe_des_utilisateurs);
        menuClients->addAction(actionListe_des_clients);
        menuClients->addAction(actionClients_avec_impay_s);
        menuClients->addAction(actionClients_avec_pr_payements);
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Gestion Star-Grace", 0));
        actionParametres->setText(QApplication::translate("MainWindow", "Parametres...", 0));
        ...
        actionListe_des_points_de_vente->setText(QApplication::translate("MainWindow", "Liste des points de vente...", 0));
        actionAutres_produits->setText(QApplication::translate("MainWindow", "Autres produits", 0));
        actionSynchroniser_les_donn_es->setText(QApplication::translate("MainWindow", "Synchroniser les donn\303\251es...", 0));
        actionSauvegarder_la_base_de_donn_es->setText(QApplication::translate("MainWindow", "Sauvegarder la base de donn\303\251es", 0));
        actionRestaurer_la_base_de_donn_es->setText(QApplication::translate("MainWindow", "Restaurer la base de donn\303\251es", 0));
        ...
        label_2->setText(QApplication::translate("MainWindow", "Point de vente", 0));
        label_3->setText(QApplication::translate("MainWindow", "Utilisateur", 0));
        label_4->setText(QApplication::translate("MainWindow", "Du", 0));
        label_5->setText(QApplication::translate("MainWindow", "Au", 0));
        QTableWidgetItem *___qtablewidgetitem2 = table_inventaire->horizontalHeaderItem(0);
        ___qtablewidgetitem2->setText(QApplication::translate("MainWindow", "Date", 0));
        QTableWidgetItem *___qtablewidgetitem3 = table_inventaire->horizontalHeaderItem(1);
        ___qtablewidgetitem3->setText(QApplication::translate("MainWindow", "Format", 0));
        QTableWidgetItem *___qtablewidgetitem4 = table_inventaire->horizontalHeaderItem(2);
        ___qtablewidgetitem4->setText(QApplication::translate("MainWindow", "Produit", 0));
        QTableWidgetItem *___qtablewidgetitem5 = table_inventaire->horizontalHeaderItem(3);
        ___qtablewidgetitem5->setText(QApplication::translate("MainWindow", "Op\303\251ration", 0));
        ...
        label_13->setText(QApplication::translate("MainWindow", "Format", 0));
        label_format->setText(QApplication::translate("MainWindow", "---", 0));
        label_14->setText(QApplication::translate("MainWindow", "En Stock", 0));
        label_qte->setText(QApplication::translate("MainWindow", "---", 0));
        label_8->setText(QApplication::translate("MainWindow", "Quantit\303\251", 0));
        unite->clear();
        unite->insertItems(0, QStringList()
         << QApplication::translate("MainWindow", "m2", 0)
         << QApplication::translate("MainWindow", "Carton", 0)
         << QApplication::translate("MainWindow", "Pi\303\250ce", 0)
        );
...
#ifndef QT_NO_TOOLTIP
        pushButton_7->setToolTip(QApplication::translate("MainWindow", "Biz", 0));
#endif // QT_NO_TOOLTIP
        pushButton_7->setText(QString());
#ifndef QT_NO_TOOLTIP
        pushButton_8->setToolTip(QApplication::translate("MainWindow", "Remise", 0));
#endif // QT_NO_TOOLTIP
        pushButton_8->setText(QString());
#ifndef QT_NO_TOOLTIP
        pushButton_6->setToolTip(QApplication::translate("MainWindow", "Imprimer", 0));
#endif // QT_NO_TOOLTIP
