/********************************************************************************
** Form generated from reading UI file 'apercufacturewithtoken.ui'
**
...
#ifndef UI_APERCUFACTUREWITHTOKEN_H
#define UI_APERCUFACTUREWITHTOKEN_H
...
class Ui_ApercuFactureWithToken
{
public:
    ...
    void setupUi(QDialog *ApercuFactureWithToken)
    {
        if (ApercuFactureWithToken->objectName().isEmpty())
            ApercuFactureWithToken->setObjectName(QStringLiteral("ApercuFactureWithToken"));
        ApercuFactureWithToken->resize(513, 815);
        verticalLayout_6 = new QVBoxLayout(ApercuFactureWithToken);
        verticalLayout_6->setObjectName(QStringLiteral("verticalLayout_6"));
        banner = new QLabel(ApercuFactureWithToken);
        ...
        groupe_client2 = new QGroupBox(ApercuFactureWithToken);
        ...
        groupBox_3 = new QGroupBox(ApercuFactureWithToken);
...
"font-weight:bold;"));
        ...
        text_header = new QGroupBox(ApercuFactureWithToken);
...
"font-weight:bold;"));
        ...
        tableWidget = new QTableWidget(ApercuFactureWithToken);
        ...
        groupBox_4 = new QGroupBox(ApercuFactureWithToken);
...
"font-size:13px;"));
        ...
        retranslateUi(ApercuFactureWithToken);

        QMetaObject::connectSlotsByName(ApercuFactureWithToken);
    } // setupUi

    void retranslateUi(QDialog *ApercuFactureWithToken)
    {
        ApercuFactureWithToken->setWindowTitle(QApplication::translate("ApercuFactureWithToken", "Dialog", 0));
        banner->setText(QString());
        groupe_client2->setTitle(QApplication::translate("ApercuFactureWithToken", "CLIENT", 0));
        client_2->setText(QString());
        groupBox_3->setTitle(QString());
        label_10->setText(QApplication::translate("ApercuFactureWithToken", "FACTURE", 0));
        label_11->setText(QApplication::translate("ApercuFactureWithToken", "N\302\260  : ", 0));
        label_token->setText(QApplication::translate("ApercuFactureWithToken", "12599655", 0));
        label_13->setText(QApplication::translate("ApercuFactureWithToken", "Date :", 0));
        label_19->setText(QString());
        date->setText(QApplication::translate("ApercuFactureWithToken", "18/07/2022", 0));
        label_20->setText(QString());
        label_15->setText(QApplication::translate("ApercuFactureWithToken", "Heure : ", 0));
        label_21->setText(QString());
        heure->setText(QApplication::translate("ApercuFactureWithToken", "13 :31:42", 0));
        label_header1->setText(QApplication::translate("ApercuFactureWithToken", "STAR GRACE", 0));
        label_header_2->setText(QApplication::translate("ApercuFactureWithToken", "Commerce G\303\251n\303\251rale Import - Export", 0));
        label_header_3->setText(QApplication::translate("ApercuFactureWithToken", "Vente de mat\303\251riaux de constructions", 0));
        label_header_4->setText(QApplication::translate("ApercuFactureWithToken", "Plomberie, carreaux, granito, baguette & divers", 0));
        label_header_5->setText(QApplication::translate("ApercuFactureWithToken", "Tel: 99 74 00 74 / 90 28 10 32", 0));
        label_pv->setText(QApplication::translate("ApercuFactureWithToken", "-", 0));
        label_header_6->setText(QApplication::translate("ApercuFactureWithToken", "LOME - TOGO", 0));
        groupBox->setTitle(QString());
        label_header_7->setText(QApplication::translate("ApercuFactureWithToken", "CLIENT ", 0));
        label_nom_client->setText(QApplication::translate("ApercuFactureWithToken", "NOM DU CLIENT", 0));
        label_contact_client->setText(QApplication::translate("ApercuFactureWithToken", "CONTACT DU CLIENT", 0));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ApercuFactureWithToken", "Format", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ApercuFactureWithToken", "DESIGNATION", 0));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ApercuFactureWithToken", "QTE", 0));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ApercuFactureWithToken", "Unit\303\251", 0));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("ApercuFactureWithToken", "Prix Unitaire", 0));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("ApercuFactureWithToken", "Montant Total", 0));
        groupBox_4->setTitle(QString());
        label_18->setText(QApplication::translate("ApercuFactureWithToken", "Arr\303\252t\303\251 la pr\303\251sente facture \303\240 a somme de cent cinq mille francs cfa", 0));
        label_30->setText(QApplication::translate("ApercuFactureWithToken", "NB : Les marchandises vendues ne sont ni reprises ni \303\251chang\303\251es. merci pour votre Achat", 0));
        label_22->setText(QApplication::translate("ApercuFactureWithToken", "Total HT ( F CFA )", 0));
        total_ht->setText(QApplication::translate("ApercuFactureWithToken", "0", 0));
        label_23->setText(QApplication::translate("ApercuFactureWithToken", "Total Remise ( F CFA )", 0));
        remise->setText(QApplication::translate("ApercuFactureWithToken", "0", 0));
        label_24->setText(QApplication::translate("ApercuFactureWithToken", "Total Impay\303\251 ( F CFA )", 0));
        tva->setText(QApplication::translate("ApercuFactureWithToken", "0", 0));
        label_29->setText(QApplication::translate("ApercuFactureWithToken", "Total TTC ( F CFA )", 0));
        total_ttc->setText(QApplication::translate("ApercuFactureWithToken", "0", 0));
    } // retranslateUi

};

namespace Ui {
    class ApercuFactureWithToken: public Ui_ApercuFactureWithToken {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_APERCUFACTUREWITHTOKEN_H
