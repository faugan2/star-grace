    ...
    ui(new Ui::Facture)
{
    ...
    QString lettre=numberToText(total_ttc);
    qDebug()<<"LETTRE="<<lettre;
    ui->label_18->setText("Arrêté la présente facture à a somme de "+lettre+" F CFA");
...
QString Facture::numberToText(uint number)
{
