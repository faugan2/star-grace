/********************************************************************************
** Form generated from reading UI file 'apercufactur.ui'
**
...
#ifndef UI_APERCUFACTUR_H
#define UI_APERCUFACTUR_H
...
public:
    ...
    void setupUi(QDialog *ApercuFactur)
    {
        if (ApercuFactur->objectName().isEmpty())
            ApercuFactur->setObjectName(QStringLiteral("ApercuFactur"));
        ApercuFactur->resize(513, 825);
        verticalLayout_6 = new QVBoxLayout(ApercuFactur);
        verticalLayout_6->setObjectName(QStringLiteral("verticalLayout_6"));
        banner = new QLabel(ApercuFactur);
        ...
        groupBox_3 = new QGroupBox(ApercuFactur);
...
"font-weight:bold;"));
        ...
        groupe_client2 = new QGroupBox(ApercuFactur);
        ...
        text_header = new QGroupBox(ApercuFactur);
...
"font-weight:bold;"));
        ...
        tableWidget = new QTableWidget(ApercuFactur);
        ...
        groupBox_4 = new QGroupBox(ApercuFactur);
...
"font-size:13px;"));
        ...
        retranslateUi(ApercuFactur);

        QMetaObject::connectSlotsByName(ApercuFactur);
    } // setupUi

    void retranslateUi(QDialog *ApercuFactur)
    {
        ApercuFactur->setWindowTitle(QApplication::translate("ApercuFactur", "Dialog", 0));
        banner->setText(QString());
        groupBox_3->setTitle(QString());
        label_10->setText(QApplication::translate("ApercuFactur", "FACTURE", 0));
        label_11->setText(QApplication::translate("ApercuFactur", "N\302\260  : ", 0));
        label_token->setText(QApplication::translate("ApercuFactur", "12599655", 0));
        label_13->setText(QApplication::translate("ApercuFactur", "Date :", 0));
        label_19->setText(QString());
        date->setText(QApplication::translate("ApercuFactur", "18/07/2022", 0));
        label_20->setText(QString());
        label_15->setText(QApplication::translate("ApercuFactur", "Heure : ", 0));
        label_21->setText(QString());
        heure->setText(QApplication::translate("ApercuFactur", "13 :31:42", 0));
        groupe_client2->setTitle(QApplication::translate("ApercuFactur", "CLIENT", 0));
        client_2->setText(QString());
        label_header1->setText(QApplication::translate("ApercuFactur", "STAR GRACE", 0));
        label_header_2->setText(QApplication::translate("ApercuFactur", "Commerce G\303\251n\303\251rale Import - Export", 0));
        label_header_3->setText(QApplication::translate("ApercuFactur", "Vente de mat\303\251riaux de constructions", 0));
        label_header_4->setText(QApplication::translate("ApercuFactur", "Plomberie, carreaux, granito, baguette & divers", 0));
        label_header_5->setText(QApplication::translate("ApercuFactur", "Tel: 99 74 00 74 / 90 28 10 32", 0));
        label_pv->setText(QApplication::translate("ApercuFactur", "-", 0));
        label_header_6->setText(QApplication::translate("ApercuFactur", "LOME - TOGO", 0));
        groupBox->setTitle(QString());
        label_header_7->setText(QApplication::translate("ApercuFactur", "CLIENT ", 0));
        label_nom_client->setText(QApplication::translate("ApercuFactur", "NOM DU CLIENT", 0));
        label_contact_client->setText(QApplication::translate("ApercuFactur", "CONTACT DU CLIENT", 0));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("ApercuFactur", "Format", 0));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("ApercuFactur", "DESIGNATION", 0));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("ApercuFactur", "QTE", 0));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("ApercuFactur", "Unit\303\251", 0));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("ApercuFactur", "Prix Unitaire", 0));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget->horizontalHeaderItem(5);
        ___qtablewidgetitem5->setText(QApplication::translate("ApercuFactur", "Montant Total", 0));
        groupBox_4->setTitle(QString());
        label_18->setText(QApplication::translate("ApercuFactur", "Arr\303\252t\303\251 la pr\303\251sente facture \303\240 a somme de cent cinq mille francs cfa", 0));
        label_30->setText(QApplication::translate("ApercuFactur", "NB : Les marchandises vendues ne sont ni reprises ni \303\251chang\303\251es. merci pour votre Achat", 0));
        label_22->setText(QApplication::translate("ApercuFactur", "Total HT ( F CFA )", 0));
        total_ht->setText(QApplication::translate("ApercuFactur", "0", 0));
        label_23->setText(QApplication::translate("ApercuFactur", "Total Remise ( F CFA )", 0));
        remise->setText(QApplication::translate("ApercuFactur", "0", 0));
        label_24->setText(QApplication::translate("ApercuFactur", "Total Impay\303\251 ( F CFA )", 0));
        tva->setText(QApplication::translate("ApercuFactur", "0", 0));
        label_29->setText(QApplication::translate("ApercuFactur", "Total TTC ( F CFA )", 0));
        total_ttc->setText(QApplication::translate("ApercuFactur", "0", 0));
    } // retranslateUi

};

namespace Ui {
    class ApercuFactur: public Ui_ApercuFactur {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_APERCUFACTUR_H
